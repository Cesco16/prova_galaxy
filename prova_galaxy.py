...
input_file = pd.read_csv(fname, header = 'infer', sep = "\t")
...
column_names = ["gene","chrom","base","strand","sm","weight","K"]
d = {'col1':gene, 'col2':chrom,'col3':base,'col4':strand,'col5':sm,'col6':weight,'col7':K}
ref = pd.DataFrame(d)
